...
- [ ] **Install clsx/tailwind-merge:** Run `npm install clsx tailwind-merge` (optional but good for dynamic classes) or stick to standard template literals if simple. *Decision: Stick to template literals for simplicity unless complex.*
